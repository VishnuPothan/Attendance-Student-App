...
public class ProfileEdit extends AppCompatActivity {
    ...
    private void UploadDetails() {
        mDatabase.child("student").child(SharedPreference.getUserID(getApplicationContext())).child("name").setValue(String.valueOf(nameText.getText()))
                .addOnSuccessListener(aVoid -> {
                    ...
                    mDatabase.child("student").child(SharedPreference.getUserID(getApplicationContext())).child("phone").setValue(String.valueOf(phoneText.getText()))
